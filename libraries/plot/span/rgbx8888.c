...
static pixelfmt_rgbx8888_t blend_pix_rgbx8888(pixelfmt_rgbx8888_t src1,
                                              pixelfmt_rgbx8888_t src2,
                                              int                 alpha)
{
  pixelfmt_rgbx8888_t r1, g1, b1;
  pixelfmt_rgbx8888_t r2, g2, b2;
                              ...
                              int         alpha)
{
  ...
  const pixelfmt_rgbx8888_t *src2 = vsrc2;

  while (length--)
  {
    *dst = blend_pix_rgbx8888(*src1, *src2, alpha);
                              ...
                              const alpha_t *alphas)
{
  ...
  while (length--)
  {
    *dst = blend_pix_rgbx8888(*src1, *src2, *alphas);
