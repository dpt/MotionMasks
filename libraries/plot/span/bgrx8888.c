...
static pixelfmt_bgrx8888_t blend_pix_bgrx8888(pixelfmt_bgrx8888_t src1,
                                              pixelfmt_bgrx8888_t src2,
                                              int                 alpha)
{
  pixelfmt_bgrx8888_t r1, g1, b1;
  pixelfmt_bgrx8888_t r2, g2, b2;
...
static void span_bgrx8888_blendconst(void       *vdst,
                                     const void *vsrc1,
                                     const void *vsrc2,
                                     int         length,
                                     int         alpha)
{
  pixelfmt_bgrx8888_t       *dst  = vdst;
  const pixelfmt_bgrx8888_t *src1 = vsrc1;
  const pixelfmt_bgrx8888_t *src2 = vsrc2;

  while (length--)
  {
    *dst = blend_pix_bgrx8888(*src1, *src2, alpha);
...
static void span_bgrx8888_blendarray(void            *vdst,
                                     const void      *vsrc1,
                                     const void      *vsrc2,
                                     int              length,
                                     const mmalpha_t *alphas)
{
  ...
  while (length--)
  {
    *dst = blend_pix_bgrx8888(*src1, *src2, *alphas);
